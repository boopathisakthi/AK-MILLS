...
function loadgstdetail() {
    ...
    binddatareportwithdata("#gvpurchasegstlist", "/gstpurchasereport", data, FilterParameter)
    purchasedownload()
    getpurchasecount()
    getpurchaseamountdetails()
    loadgstzerodetail();
...
function getpurchasecount()
{
    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           if(data.length==0)
           {
            $('#lblpurchase_count').text("0")

           }else{
          $('#lblpurchase_count').text(data[0].myCount)
...
function getpurchaseamountdetails()
{
    let FilterParameter = {
        fromdate: Converdate($('#txtfromdate').val()),
        todate: Converdate($('#txttodate').val()),
...
function loadgstzerodetail() {
    ...
    binddatareportwithdata("#gvpurchasegstzerolist", "/gstzeropurchasereport", data, FilterParameter)
